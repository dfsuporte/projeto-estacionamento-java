...
public class Tela_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemPreco = new javax.swing.JMenuItem();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"00001", "001", "abc-1234", "Celta", "17:00", null, "29/05/2011"},
                {null, null, "", null, null, null, null},
                {null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null}
            },
            new String [] {
                "código", "Box", "Placa", "Veiculo", "Entrada", "Saida", "Data"
            }
        ));
        jTable1.setGridColor(new java.awt.Color(102, 0, 102));
        jScrollPane1.setViewportView(jTable1);

        jScrollPane1.setBounds(20, 200, 760, 320);
        jDesktopPane1.add(jScrollPane1, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "  Registro de entrada  ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(102, 0, 102))); // NOI18N

        jLabel2.setText("Placa");

        jLabel3.setText("Veículo");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Celta", "Palio", "Corsa", "Gol", "Saveiro" }));

        jLabel4.setText("Cor");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Branco", "Prata", "Amarelo", "Vermelho", "Preto", "Verde" }));
        ...
        jPanel1.setBounds(20, 10, 370, 120);
        jDesktopPane1.add(jPanel1, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "  Registro de saída  ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(102, 0, 102))); // NOI18N
        ...
        jPanel2.setBounds(400, 10, 380, 120);
        jDesktopPane1.add(jPanel2, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jPanel3.setBackground(new java.awt.Color(133, 86, 133));
        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jButton3.setText("Todos os registros");

        jButton4.setText("Dentro do estacionamento");

        jButton5.setText("Box disponiveis");
        ...
        jPanel3.setBounds(0, 150, 830, 50);
        jDesktopPane1.add(jPanel3, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jPanel5.setBackground(new java.awt.Color(133, 86, 133));
        ...
        jPanel5.setBounds(0, 520, 830, 40);
        ...
        jMenuItemPreco.setText("Preços");
        jMenuItemPreco.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemPrecoActionPerformed(evt);
            }
        });
        jMenu2.add(jMenuItemPreco);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jDesktopPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 816, Short.MAX_VALUE)
        );
    ...
    private void jMenuItemBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBoxActionPerformed
        ...
        cadastroBox.setLocationRelativeTo(null);
    ...
    private void jMenuItemTipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemTipoActionPerformed
        ...
        cadastroTipo.setLocationRelativeTo(null);
        cadastroTipo.setVisible(true);
        
    }//GEN-LAST:event_jMenuItemTipoActionPerformed

    private void jMenuItemPrecoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemPrecoActionPerformed
        Tela_Cadastro_Preco cadastroPreco = new Tela_Cadastro_Preco();
        cadastroPreco.setLocationRelativeTo(null);
        cadastroPreco.setVisible(true);
    }//GEN-LAST:event_jMenuItemPrecoActionPerformed
    ...
    private void jMenuItemCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCategoriaActionPerformed
        Tela_Cadastro_Categoria cadastroCategoria = new Tela_Cadastro_Categoria();
    ...
    private javax.swing.JMenuItem jMenuItemPreco;
